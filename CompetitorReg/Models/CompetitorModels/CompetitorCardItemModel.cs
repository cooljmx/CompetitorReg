...
{
    public class CompetitorCardItemModel : VirtualNotifyPropertyChanged
    {
        private int id;
        ...
        public string ResidencePlace
        {
            ...
            set
            {
                ...
                NotifyPropertyChanged("ResidencePlace");
                if (residencePlace == incorporationPlace)
                {
                    isSamePlace = true;
                    NotifyPropertyChanged("IsSamePlace");
                }
            }
        }
        ...
        public bool IsSamePlace
        {
            ...
            set
            {
                ...
                if (value)
                {
                    ResidencePlace = incorporationPlace;
                }
            }
        }
